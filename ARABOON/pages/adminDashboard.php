...
<head>
    ...
    <title>ARABOON - admin dashboard</title>
    <style>
    </style>
</head>
<body>
            ...
            <div class="feature">
                ...
                <div class="feature-card">
                    <div class="feature-item">
                        <h5><a href="viewUsers.php">View users</a></h5>
                    </div>
                    <div class="feature-item">
                        <h5><a href="addUser.php">Add User</a></h5>
                    </div>
                    <div class="feature-item">
                        <h5><a href="addManga.php">Add manga</a></h5>
                    </div>
                    <div class="feature-item">
                        <h5><a href="deleteManga.php">Delete Manga</a></h5>
                    </div>
                    <div class="feature-item">
                        <h5><a href="updateManga.php">Update Manga</a></h5>
                    </div>
                </div>
            </div>
        </aside>
        <section style="margin: 20px auto;" class="glass">
            <div>
                <form action="chapterPage.php" method="get">
                    ...
                    <input value="Select" type="submit" id="submit-btn" disabled>
                </form>
            </div>
        </section>
    </main>
